...
<nav class="w3-sidebar w3-collapse w3-black w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="manageStaff.jsp" class="w3-bar-item w3-button w3-padding w3-blue "><i class="fa fa-users fa-fw"></i>  Staff Management</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
 ...
 <h1>Staff</h1>
	...
	<form id="regStaffForm" name="regStaffForm" method="post" text-align="center" action="StaffController">
	
		
		<label for="StaffID">Staff ID:</label><br>  
		<div text-align="center">      
        <input type="text" id="StaffID" name="StaffID" required="required"><br>
        </div>
        <label for="StaffUserName">Staff Username:</label><br>        
        <div text-align="center">
        <input type="text" id="StaffUserName" name="StaffUserName" required="required"><br>
       </div>
  		<label for="StaffPassword">Staff Password:</label><br>        
        <div text-align="center">
        <input type="text" id="StaffPassword" name="StaffPassword" required="required"><br><br>
       </div>
        <label for="StaffName">Staff Name:</label><br>        
        <div text-align="center">
        <input type="text" id="StaffName" name="StaffName" required="required"><br><br>	
		</div>
        <label for="StaffTelnum">Staff Telnum:</label><br>        
        <div text-align="center">
        <input type="text" id="StaffTelnum" name="StaffTelnum" required="required"><br><br>
        </div>
