    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="w3-pull-left">
                <h2 class="headertekst" align="center">Supplier Management</h2>
            </div>
            <div class="w3-pull-right">
                <a class="w3-button w3-green" href="creatSupplier.jsp"> Create New Supplier</a>
            </div>
        </div>
    </div>
	<br>
...
%>
        ...
        <tr>
            ...
            <td><%=resultSet.getString("supplierTelNum") %></td>
                    
            <td>
            
            <a class="w3-button w3-teal" href="SupplierController?action=viewSupp&SupplierID=<%=resultSet.getString("supplierid") %>"> View</a>
                
            <a class="w3-button w3-red" href="SupplierController?action=deleteSupplier&SupplierID=<%=resultSet.getString("supplierid") %> "> Delete</a>
                
            <a class="w3-button w3-amber" href="SupplierController?action=updateSupplier&SupplierID=<%=resultSet.getString("supplierid") %>"> Update</a>
