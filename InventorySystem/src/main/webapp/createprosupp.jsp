...
<nav class="w3-sidebar w3-collapse w3-black w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="viewreqpro.jsp" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-users fa-fw"></i>  View Requested Product</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
	...
	<br>
	<form id="regProductForm" name="regProductForm" method="post" action="ListOfProduct.jsp">
     <div>
     <div  style="text-indent: 35%">
         <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group row">
                <strong class="col-md-4 col-form-label text-md-right">Product ID:</strong>
                <input type="text" id="productid" name="productid" class="form-control col-md-6" placeholder="Products Name">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group row">
                ...
                <input type="text" id="productprice" name="productsellprice" class="form-control col-md-6" placeholder="0.00">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group row">
                <strong class="col-md-4 col-form-label text-md-right">Product Detail:</strong>
                <textarea class="form-control col-md-6" style="height:150px" name="productsdetail" placeholder="Products Detail"></textarea>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group row">
                ...
                <input type="number" id="productreorderlevel" name="productreorderlevel" class="form-control col-md-6" placeholder="0">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group row">
                <strong class="col-md-4 col-form-label text-md-right">Expiry Date:</strong>
                <input type="date" id="productexpirydate" name="productexpirydate" class="form-control col-md-6" placeholder="">
            </div>
        </div>
        <br><br>
    </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 w3-center">
				<a class="w3-btn w3-red" href="ListOfProduct.jsp"> Cancel</a>
