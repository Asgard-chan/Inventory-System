    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="w3-pull-right">
            	<a class="w3-button w3-blue fa fa-arrow-left" href="Dashboard.jsp"> Back</a>
        	</div>
            <div class="w3-pull-left">
                <h2 class="headertekst" align="center">Staff Management</h2>
            </div>
            <div class="w3-pull-right">
                <a class="w3-button w3-green" href="createStaff.jsp"> Create New Staff</a>
            </div>
        </div>
    </div>
	<br>
...
%>
        ...
        <tr>
            ...
            <td><%=resultSet.getString("stafftelnum") %></td>
            ...
            <td>
                <form action="{{ route('products.destroy',$product->id) }}" method="POST">
                    ...
                    <a class="w3-button w3-teal" href="StaffController?action=viewStaffp&StaffID=<%=resultSet.getString("staffid") %>">View</a>

                    <a class="w3-button w3-red" href="StaffController?action=deleteStaff&StaffID=<%=resultSet.getString("staffid") %> "> Delete</a>
                
                    <a class="w3-button w3-amber" href="StaffController?action=updateStaff&StaffID=<%=resultSet.getString("staffid") %>"> Update</a>
                </form>
            </td>
        </tr>
<% 
