...
<nav class="w3-sidebar w3-collapse w3-black w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="Dashboard.jsp" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-home fa-fw"></i>  Home</a>
    <a href="/InventorySystem/ProductController?action=listProduct" class="w3-bar-item w3-button w3-padding" ><i class="fa fa-table fa-fw" ></i>  Product Management</a>
