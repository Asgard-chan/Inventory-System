  ...
  <br>
    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="w3-pull-left">
                <h2 class="headertekst" align="center">List Request Product</h2>
            </div>
            <div class="w3-pull-right">
                <a class="w3-button w3-green" href="requestProduct.jsp"> + Request Product</a>
            </div>
        </div>
        <div class="w3-center search-container">
    		<form action="/action_page.php">
      		<input type="text" placeholder="SupplierID/name" name="search">
    ...
    <table>
        <tr>
            ...
            <th width="250px" align="center">Status</th>
        </tr>
        ...
        <tr>
            ...
            <td>
                <form action="{{ route('products.destroy',$product->id) }}" method="POST">
                    ...
                    <a class="w3-button w3-teal" href="viewRequest.jsp">View</a>
            ...
            <td>
            	<form action="{{ route('products.destroy',$product->id) }}" method="POST">
					<a id="demo" class="w3-button" style="color=blue" href="#">Delivery</a>
                	<script>
