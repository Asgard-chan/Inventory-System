	...
	<div class="row">
    	<div class="col-lg-12 margin-tb">
        	<div class="w3-pull-left">
            	<h2 class="w3-headertekst" align="center">Update Staff</h2>
        	</div>
...
%>
        ...
        <div class="col-xs-30 col-sm-30 col-md-30">
            <div class="form-group row">
                <strong class="col-md-4 col-form-label text-md-right">Staff Id:</strong>
                <input type="text" name="id" id="id" class="form-control col-md-10"  value="<%=resultSet.getString("staffid") %>"/>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group row">
                <strong class="col-md-4 col-form-label text-md-right">Staff Username:</strong>
                <input type="text" name="name" id="name" class="form-control col-md-6" value="<%=resultSet.getString("staffusername") %>" />"/>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group row">
                <strong class="col-md-4 col-form-label text-md-right">Staff Password:</strong>
                <input type="text" name="pwsd" id="pwsd" class="form-control col-md-6" value="<%=resultSet.getString("staffpassword") %>"/>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group row">
                <strong class="col-md-4 col-form-label text-md-right">Staff Name:</strong>
                <input type="text" name="email" id="email" class="form-control col-md-6" value="<%=resultSet.getString("staffname") %>"/>
            </div>
        </div>
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group row">
                <strong class="col-md-4 col-form-label text-md-right">Staff Tel Num</strong>
                <input type="text" name="tel" id="tel" class="form-control col-md-6" value="<%=resultSet.getString("stafftelnum") %>"/>
            </div>
