    ...
    <div align="center">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group row">
                <p><strong class="col-md-4 col-form-label text-md-right">Product ID:</strong><c:out value="${product.productId}" /></p>
                <a class="form-control col-md-4"></a>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group row">
               <p> <strong class="col-md-4 col-form-label text-md-right">Product Name:</strong><c:out value="${product.productName}" /></p>
                <a class="form-control col-md-4"></a>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group row">
               <p> <strong class="col-md-4 col-form-label text-md-right">Product Type:</strong><c:out value="${product.productType}" /></p>
                <a class="form-control col-md-4"></a>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group row">
               <p> <strong class="col-md-4 col-form-label text-md-right">Product Price(RM):</strong><c:out value="${product.productPrice}" /></p>
                <a class="form-control col-md-4"></a>
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group row">
               <p> <strong class="col-md-4 col-form-label text-md-right">Product Quantity:</strong><c:out value="${product.productsQuantity}" /></p>
                <a class="form-control col-md-4"></a>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group row">
               <p> <strong class="col-md-4 col-form-label text-md-right">Product reorder Level:</strong><c:out value="${product.reorderLevel}" /></p>
                <a class="form-control col-md-4"></a>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group row">
               <p> <strong class="col-md-4 col-form-label text-md-right">Expiry date:</strong><c:out value="${product.expiryDate}" /></p>
                <a class="form-control col-md-4"></a><br>
            </div>
        </div><br><br>
        <div class="col-xs-12 col-sm-12 col-md-12 text-center">
            <a class="w3-button w3-teal btn-primary" href="/InventorySystem/ProductController?action=listProduct"> Done</a>
