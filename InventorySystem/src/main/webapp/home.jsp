...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="/LoginServlet" method="post" style="width:30%;">
    ...
    <div class="container">
      ...
      <a type="submit" class="w3-button w3-green btn-primary" style="  background-color: #04AA6D;
         color: white;
         padding: 14px 20px;
         margin: 8px 0;
         border: none;
  ...
  <div id="id02" class="modal">
    ...
    <div class="container">
      <label for="uname"><b>Username</b></label>
      <input type="text" placeholder="Enter Username" name="supplierusername" required>

      <label for="psw"><b>Password</b></label>
      <input type="password" placeholder="Enter Password" name="supplierpassword" required>
        
      <a type="submit" class="w3-button w3-green btn-primary" href="#" style="  background-color: #04AA6D;
         color: white;
         padding: 14px 20px;
         margin: 8px 0;
         border: none;
