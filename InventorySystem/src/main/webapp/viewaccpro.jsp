...
<title>View Accepted Product</title>
...
<nav class="w3-sidebar w3-collapse w3-black w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="viewaccpro.jsp" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-users fa-fw"></i>  View Accepted Product </a>
    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="w3-pull-left">
                <h2 class="headertekst" align="center">Accepted Product</h2>
            </div>
        </div>
    </div>
	<br>
