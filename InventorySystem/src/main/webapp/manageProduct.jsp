    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="w3-pull-left">
                <h2 class="headertekst" align="center">Product Management</h2>
            </div>
            <div class="w3-pull-right">
                <a class="w3-button w3-green" href="createProduct.jsp"> Create New Product</a>
            </div>
            <br>
            <div class="w3-pull-right">
                <a class="w3-button w3-yellow" href="restockProduct.jsp"> Restock Product &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
            </div>
        </div>
    </div>
	<br>
...
%>
        ...
        <tr>
            ...
            <td><%=resultSet.getString("salesprice") %></td>
            <td><%=resultSet.getString("productquantity") %></td>
            <td><%=resultSet.getString("reorderlevel") %></td>
            <td>28/05/2022</td>
            ...
            <td>
                <form action="{{ route('products.destroy',$product->id) }}" method="POST">
                    ...
                    <a class="w3-button w3-teal" href="viewProduct.jsp">View</a>

                    <a class="w3-button w3-amber" href="updateProduct.jsp">Update</a>
